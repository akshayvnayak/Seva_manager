...
def tithi_tests():
  ...
  apr20 = gregorian_to_jd(Date(2019, 5, 16))
  apr21 = gregorian_to_jd(Date(2019, 4, 21))
  date5 = gregorian_to_jd(Date(2019,4,41))
  print(tithi(date5, mangaluru))  # Expected: krishna ashtami (23), ends at 27:07:09
  ...
  print(tithi(apr21, mangaluru))   # Expected: [10, [5, 22, 6]]
  return
